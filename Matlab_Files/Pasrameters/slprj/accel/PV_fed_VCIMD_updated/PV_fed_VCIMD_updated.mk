...
MODEL                = PV_fed_VCIMD_updated
MODULES              = 
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/PV_fed_VCIMD_updated.exe
MAKEFILE             = PV_fed_VCIMD_updated.mk
MATLAB_ROOT          = S:/Matlab R2019a
ALT_MATLAB_ROOT      = S:/Matlab R2019a
MATLAB_BIN           = S:/Matlab R2019a/bin
ALT_MATLAB_BIN       = S:/Matlab R2019a/bin
MASTER_ANCHOR_DIR    = 
START_DIR            = R:/IOP/Matlab_Files/Pasrameters
S_FUNCTIONS_LIB      = 
NUMST                = 5
NCSTATES             = 26
BUILDARGS            = MATLAB_ROOT=%MATLAB_ROOT% ALT_MATLAB_ROOT=%ALT_MATLAB_ROOT% MATLAB_BIN=%MATLAB_BIN% ALT_MATLAB_BIN=%ALT_MATLAB_BIN% 
MULTITASKING         = 0
INTEGER_CODE         = 0
MAT_FILE             = 0
ALLOCATIONFCN        = 0
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/PV_fed_VCIMD_updated \
...
%.obj : $(START_DIR)/slprj/accel/PV_fed_VCIMD_updated/%.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $<
